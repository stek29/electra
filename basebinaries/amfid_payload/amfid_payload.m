...
static int old_MISValidateSignatureAndCopyInfo(NSString* file, NSDictionary* options, NSMutableDictionary** info) {
    return 1;
}
...
int main(int argc, char *argv[]) {
    @autoreleasepool {
        ...
        retcode = fake_MISValidateSignatureAndCopyInfo(file, options, &dict);
